...
I've several different setups for immersing in Japanese, but [animebook](https://animebook.github.io/) continues to be the best in my opinion. It's incredibly simple and easy to use, it makes lookups quick and easy, and it only takes a few seconds to re-time subtitles with it. Oh, and it's also faster than just about anything else for sentence mining.
...
Next you'll want some [dictionaries](https://foosoft.net/projects/yomichan/#dictionaries) for Yomichan. If you don't have your own dictionaries that you prefer, a good set to start with is [JMdict](https://foosoft.net/projects/yomichan/dl/dict/jmdict_english.zip), [JMnedict](https://foosoft.net/projects/yomichan/dl/dict/jmnedict.zip), [KireiCake](https://foosoft.net/projects/yomichan/dl/dict/kireicake.zip), [KANJIDIC](https://foosoft.net/projects/yomichan/dl/dict/kanjidic_english.zip), and [Kanjium](https://foosoft.net/projects/yomichan/dl/dict/kanjium_pitch_accents.zip). You can also find frequency lists [here](https://docs.google.com/document/d/1IUWkvBxhoazBSTyRbdyRVk7hfKE51yorE86DCRNQVuw/edit) and [here](https://mega.nz/file/fQ9VHAIA#P8M1dyLiM-JDb_Q0ZyeEw0cGIcNER6K2Iuh3HzNRPcI).
